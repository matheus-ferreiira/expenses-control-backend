...
use App\Domains\Prices\Policies\PriceCategoryPolicy;
use App\Domains\Prices\Policies\PriceProductPolicy;
use App\Domains\Prices\Policies\PricePurchasePolicy;
use App\Domains\Prices\Policies\PriceRecordPolicy;
use App\Domains\Prices\Policies\PriceSalePolicy;
use App\Domains\Prices\Policies\PriceStorePolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(PriceCategory::class, PriceCategoryPolicy::class);
        Gate::policy(PriceStore::class, PriceStorePolicy::class);
        Gate::policy(PriceProduct::class, PriceProductPolicy::class);
        Gate::policy(PriceRecord::class, PriceRecordPolicy::class);
        Gate::policy(PricePurchase::class, PricePurchasePolicy::class);
        Gate::policy(PriceSale::class, PriceSalePolicy::class);
